...
const createDummyRouter = require("./helpers/dummy_router.js");
const app = express();
...
MongoClient.connect("mongodb://127.0.0.1:27017", { useUnifiedTopology: true })
    .then(client => {
        ...
        const dummySharesWeeklyRouter = createDummyRouter(dummySharesWeeklyCollection);
        app.use("/api/dummySharesWeekly", dummySharesWeeklyRouter)
    })
    .catch(console.error);
